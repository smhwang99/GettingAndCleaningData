...
#
# Step 1. download, unzip and import Samsung Data set
#
...
#
# Step 4. Creates a second, independent tidy data set with the average of each
...
#
# Step 6. Write the tidyData to "tidyData.txt" in current directory
#
